  ...
  <body>
    <main class="container mt-5">
        ...
        <div class="row d-flex justify-content-between">
            <h3>Aulas</h3>
            <a href="/aula/inserir" class="btn btn-primary"> <i class="fas fa-plus"></i> Nova aula</a>
        </div>
        ...
        <table class="table table-stripped table-hover mt-5" id="tabela">
            ...
            <tbody>
                <?php while($aula = $resultado->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        <td><?= $aula['nome'] ?></td>
                        <td><?= $aula['inicio'] ?></td>
                        <td><?= $aula['fim'] ?></td>
                        <td>
                            <a href="/aula/alterar/id/<?= $aula["id"] ?>" class="btn btn-sm btn-warning">Alterar</a>
                            <a href="/aula/excluir/id/<?= $aula["id"] ?>" class="btn btn-sm btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
