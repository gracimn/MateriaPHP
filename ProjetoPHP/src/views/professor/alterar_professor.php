        ...
        <form action="/professor/editar" method="POST">
            <div class="row mb-3 mt-3">
                <div class="col-6">
                    ...
                    <input type="number" class="form-control" maxlength="60" name="idade" placeholder="Idade" value="<?= $resultado["idade"];  ?>">

                    <label for="materia" class="form-label">Materia</label>
                    <input type="text" class="form-control" maxlength="60" name="materia" placeholder="Materia" value="<?= $resultado["materia"];  ?>">
