  ...
  <body>
    <main class="container mt-5">
        ...
        <table class="table table-stripped table-hover mt-5" id="tabela">
            ...
            <tbody>
                <?php while($professor = $resultado->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                        <td><?= $professor['nome'] ?></td>
                        <td><?= $professor['idade'] ?></td>
                        <td><?= $professor['materia'] ?></td>
                        <td>
                            <a href="/professor/alterar/id/<?= $professor["id"] ?>" class="btn btn-sm btn-warning">Alterar</a>
                            <a href="/professor/excluir/id/<?= $professor["id"] ?>" class="btn btn-sm btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
